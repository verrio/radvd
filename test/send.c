...
#else
	unsigned char expected[] = {
		0x05, 0x01, 0x00, 0x00, 0x00, 0x00, 0x05, 0x04
	};
...
#else
	unsigned char expected[] = {
		0x22, 0x02, 0x1f, 0x1d, 0x00, 0x00, 0x00, 0x2a,
		0x20, 0xaa, 0x01, 0x23, 0x00, 0x00, 0x00, 0x00,

		0x22, 0x03, 0x41, 0x05, 0x00, 0x00, 0x00, 0x07,
		0x20, 0xab, 0x01, 0x24, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x23,

		0x22, 0x02, 0x36, 0x05, 0x00, 0x00, 0x00, 0x07,
		0xf0, 0xf0, 0xca, 0xca, 0x07, 0x53, 0x00, 0x00,
	};
...
#else
	unsigned char expected[] = {
		0x23, 0x03, 0x00, 0x0a, 0x00, 0x02, 0x00, 0x11,
...
Suite * send_suite(void)
{
	...
	tcase_add_test(tc_build, test_add_lowpan6co);
